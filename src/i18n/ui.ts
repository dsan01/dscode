...
export const labels = {
  es: {
    ...
    "hero.desc":
      "Hola, soy David Sanchez. Transformo tus ideas en experiencias digitales únicas, uniendo creatividad y desarrollo para llevar tu proyecto al siguiente nivel.",
    "hero.avalibe": "Disponible",
    ...
    "errorPage.error404.title": "Ups... Esta Página se Perdió en el Código",
  ...
  en: {
    ...
    "hero.title": "Web Developer & Digital Experience Designer",
    "hero.desc":
      "Hi, I'm David Sanchez. I transform your ideas into unique digital experiences, bringing together creativity and development to take your project to the next level.",
    "hero.avalibe": "Avalible",
